...
#include <LiquidCrystal_I2C.h>  // Required by LCDKeypad
#include <LCDKeypad.h>
#include "RTClib.h"
...
// It handles the LCD screen and buttons
LCDKeypad lcd;
...
void showTime()
{
    ...
    lcd.setCursor(0, 3);           // Moves  the cursor of the display to the next line
    lcd.print("Temperature: ");
    lcd.print("Temperature: ");
    Vin = analogRead (sensor);  /*   Tells the Arduino to read the pin and stores the value in “Vin” */
    Temperature=(500*Vin)/1023;
    lcd.setCursor(0, 4);           // Moves  the cursor of the display to the next line/* Converts the voltage value into temperature and stores it into the “Temperature”  variable  (in  ºC)*/
